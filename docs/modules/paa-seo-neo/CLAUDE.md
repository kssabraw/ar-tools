...
> gate) is BUILT** to PRD §12 (owner greenlit 2026-09-15) on a **draft PR**, ships
> DARK behind `paa_campaign_enabled` — the module's phased scope (§6) is now
> complete. See the module `HANDOFF.md`. PR [#1117](https://github.com/kssabraw/ar-tools/pull/1117), 2026-09-15:
