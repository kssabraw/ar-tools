...
**Status:** Phases 0–2 built 2026-09-02 (migration applied live; pure core; store + API + suggest job + immediate run; sibling internal links end-to-end). Phases 3–5 (Matrix tab UI, drip release, bulk publish) not built. No UI yet — the matrix is API-only so far.
**Owner:** Kyle
