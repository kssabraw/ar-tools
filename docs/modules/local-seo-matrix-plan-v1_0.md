...
**Status:** Phases 0–3 built 2026-09-02 (migration applied live; pure core; store + API + suggest job + immediate run; sibling internal links end-to-end; the Matrix tab UI). Phases 4–5 (drip release, bulk publish) not built.
**Owner:** Kyle
