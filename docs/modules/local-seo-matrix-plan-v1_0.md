...
**Status:** Phases 0–1 built 2026-09-02 (migration applied live; pure core; store + API + suggest job + immediate run). Phases 2–5 (nlp-api sibling links, Matrix tab UI, drip release, bulk publish) not built. No UI yet — Phase 1 is API-only.
**Owner:** Kyle
