...
**Still open:** folding the ratified 25 into the SOP's link-equity section and the Page Type Reference §1.2 (both still carry the unratified >40 note). The module reads its own constant, so this is documentation catch-up, not a blocker.
