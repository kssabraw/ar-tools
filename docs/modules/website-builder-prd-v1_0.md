...
**Still open:** folding the ratified 25 into the **SOP's** link-equity section. (The Page Type Reference did it in v3.6 — that half is done.) Also outstanding upstream: SOP ratification of the Areas We Serve auto-trigger threshold (reference R6).
