...
**Still open:** the ratified figure itself (Kyle/Ryan), per the Page Type Reference §1.2's note that a number which blocks work needs ratifying into the SOP's link-equity section.
