...
**Authored:** 2026-07-11 · **Status:** **Phase 0 (foundations) built** — the Labs client, tables/migration, config, and the unit-tested pure gap/scoring core; Phases 1–5 ahead · Competitive-intelligence module (the "SEMrush clone")
