...
- **History list**: all posts with status chips (draft / scheduled / publishing / live / rejected / failed / deleted), search URL links, edit (patch) + delete (both via API, reflected locally).
