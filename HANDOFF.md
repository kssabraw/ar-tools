...
## ⏩ Update — 2026-09-15 · **Brand Guide Generator — Phase 2 (grounded synthesis + coherence check + regulated guardrail) — BUILT + MERGED (PR [#1145](https://github.com/kssabraw/ar-tools/pull/1145))** (latest)
