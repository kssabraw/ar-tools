...
## ⏩ Update — 2026-09-15 · **Brand Guide Generator — Phase 3 (PDF render + render profiles + the `brand_guide_render` job) — BUILT + MERGED (PR [#1150](https://github.com/kssabraw/ar-tools/pull/1150))** (latest)
