-- Add the github_infer_patterns job type (existing-site URL/slug convention
-- discovery → clients.github_inferred_patterns). Recreates the CHECK from the
-- exact live definition + the new value; strictly additive.
