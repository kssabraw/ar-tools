...
async def scan_client(client: dict, config: dict | None = None) -> dict:
    """Discover the client's site URLs and insert any new ones as syndication
    items. Returns {discovered, new, source}. Best-effort — a site with no
    readable sitemap/index yields {discovered: 0, new: 0, source: "none"}."""
