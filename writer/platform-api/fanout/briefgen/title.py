...
def generate_title_scope(
    ...
    base_rules = (
        ...
        "(specific products, people, places, or concepts — named things, not generic "
        "words), be written for the target audience in the vocabulary that audience "
        "actually uses (infer the audience from the SERP and AI answers), and be "
