...
async def analyze(client_id: UUID, body: AnalyzeRequest | None = None, auth: dict = Depends(require_auth)):
    internal_linking.enqueue_analyze(str(client_id), body.engagement_id if body else None)
