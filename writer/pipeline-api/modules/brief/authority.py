...
AUTHORITY_SYSTEM_PROMPT = (
    ...
    "CROSS-DOMAIN PERSPECTIVE (industry blind-spot mitigation): For at "
    "least one of the headings you emit, draw on how an ADJACENT industry "
    "approaches a structurally similar problem. Examples: medical clinic "
    "marketing learning from law firm intake processes; B2B SaaS pricing "
    "learning from consumer subscription churn research; ecommerce "
